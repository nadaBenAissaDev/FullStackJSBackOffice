            ...
            <Card className="shadow">
              ...
              <Table className="align-items-center table-flush" responsive>
                ...
                <tr>
                    ...
                    <td>
                        https://linkedin/in/ichrak-salhi.com
                    </td>
                    <td>
                      <Badge color="" className="badge-dot mr-4">
                        <i className="bg-warning" />
                       ichrakSalhi@esprit.tn
                      </Badge>
                    </td>
                    <td className="text-right">
                      <UncontrolledDropdown>
                  ...
                  <tr>
                    ...
                    <td>
                        https://linkedin/in/imen-ElHakim.com
                    </td>
                    <td>
                      <Badge color="" className="badge-dot mr-4">
                        <i className="bg-warning" />
                       imenELHAKIM@esprit.tn
                      </Badge>
                    </td>
                    <td className="text-right">
                      <UncontrolledDropdown>
                  ...
                  <tr>
                    ...
                    <td>
                        https://linkedin/in/najla-daoud.com
                    </td>
                    <td>
                      <Badge color="" className="badge-dot mr-4">
                        <i className="bg-warning" />
                        najla-daoud@esprit.tn
                      </Badge>
                    </td>
                    <td className="text-right">
                      <UncontrolledDropdown>
                  ...
                  <tr>
                    ...
                    <td>
                        https://linkedin/in/nada-benaiisa.com
                    </td>
                    <td>
                      <Badge color="" className="badge-dot mr-4">
                        <i className="bg-warning" />
                        NadaBenAisaa@esprit.tn
                      </Badge>
                    </td>
                    <td className="text-right">
                      <UncontrolledDropdown>
