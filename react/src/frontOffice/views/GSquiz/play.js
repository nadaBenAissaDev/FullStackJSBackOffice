...
import { getFreeQuestions, fetchQuiz, endFreeQuiz } from '../../../actions/quizActions';//../../actions/quizActions;
            ...
            <div className="questions" style={{color:'black'}}>
               <h2> TEST </h2>
                <div className="lifeline-container">
                    <p>
                        <span><Icon onClick={this.handleLifeline} className={classnames('mdi mdi-set-center mdi-24px lifeline-icon',{
                                        'lifeline-icon-empty': this.state.fiftyFifty === 0})} icon={setCenter} />
                ...
                {this.state.hints > 0
                     ?
                     <span>
                         <Icon onClick={this.handleHints}  id="hints"  className={classnames('mdi mdi-lightbulb-on mdi-24px lifeline-icon', {
                        'lifeline-icon-empty': this.state.hints === 0})} icon={lightbulbOnOutline}/>
                        <span className="lifeline">{this.state.hints}</span>
                     </span>
                     :
                     <span  onClick={this.handleLifeline}
                     id="hints"
